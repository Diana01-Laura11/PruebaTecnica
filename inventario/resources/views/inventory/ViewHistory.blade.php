        ...
        <div class="content-area">
            ...
            <div class="inventory-container">
                <div class="inventory-header">
                    ...
                    <h1 class="inventory-title">Módulo con el historial de movimientos de “Entrada” y “Salida” productos</h1>
                    <div class="header-decoration"></div>
                </div>

                <div class="filter-section" style="margin-bottom: 20px; margin-left:40px;">
                    <p style="font-weight: 500; color: var(--primary-color); margin-bottom: 8px; margin-top:10px;">
                        <i class="fas fa-filter"></i> Filtrar por
                    </p>

                    <div class="select-wrapper" style="position: relative; width: 250px;">
                ...
                <div class="inventory-content">
                    <table class="inventory-table">
                        ...
                        <tbody id="tabla-registros">
                            ...
                            <tr data-tipo="{{ strtolower($registro->tipo_movimiento) }}">
                                <td>{{ $registro->idUsuario }}</td>
                                <td>{{ $registro->nombre }}</td>
                                <td>
                                    <span class="badge-movimiento badge-{{ strtolower($registro->tipo_movimiento) }}">
...
<script>
    document.getElementById('filtro-movimientos').addEventListener('change', function() {
        const tipo = this.value;
        const filas = document.querySelectorAll('.inventory-table tbody tr');

        filas.forEach(fila => {
            const tipoMovimiento = fila.getAttribute('data-tipo') || '';

            if (tipo === 'todos' || tipoMovimiento === tipo) {
                fila.style.display = '';
            } else {
