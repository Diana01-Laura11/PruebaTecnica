...
<body>
    <div class="form-container">
        <div class="form-header">
            ...
            <h1 class="form-title">Registrar Salida de Producto</h1>
            <div class="header-decoration"></div>
        </div>
        
        <form action="{{ route('departure.store', $producto->idProducto) }}" method="POST">
            @csrf
            <div class="form-content">
                <div class="form-group">
                    <label for="cantidad" class="form-label">
                        Cantidad a retirar del producto: <strong>{{ $producto->nombre }}</strong>
                        <span class="stock-info">(Stock disponible: {{ $producto->cantidad }})</span>
                    </label>
                ...
                <div class="actions-bar">
                    <a href="{{ route('inventory.ViewDepartures') }}" class="btn btn-outline">
