        ...
        <div class="content-area">
            ...
            <div class="inventory-container">
                <div class="inventory-header">
                    ...
                    <h1 class="inventory-title">Módulo para sacar(restar) inventario del almacén (Salida de productos)</h1>
                    <div class="header-decoration"></div>
                </div>
                    ...
                    <table class="inventory-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="{{ route('departure.departuresproduct', $producto->idProducto) }}" class="action-icon">
                                            <i class="fa fa-arrow-right"></i>
                                        </a>
                                        
                                        
                                        <form id="departures-form-{{ $producto->idProducto }}" 
                                            action="{{ route('departure.store', $producto->idProducto) }}" 
                                            method="POST" 
                                            style="display: none;">
                                            @csrf
                                            @method('DELETE')
